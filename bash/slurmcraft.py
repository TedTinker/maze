...
add_this("many",   {"hard_maze" : True, "maze_list" : "\"('1','2','3')\"", "max_steps" : 16, "steps_per_epoch" : 16, "naive_eta" : 3, "free_eta" : 3, "beta" : [{"curiosity" : "free"}, .03], "tau" : .2, "epochs" : "\"(500,1500,3000)\"", "default_reward" : "\"((1,0),)\"", "better_reward" : "\"((1,10),)\""})

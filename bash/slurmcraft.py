...
slurm_dict = {
    ...
    "ef_state"  : "--state_forward True --alpha None --curiosity free --beta_zq 0",
    
    "ef_log_prob_state" : "--state_forward True --alpha None --curiosity free --beta_zq 0 --accuracy log_prob",
